...
func _process(delta):
	...
	ball_8.rotation = lerp(ball_8.rotation, ball_1.rotation + (ball_target.rotation / 2), 0.9)
	ball_7.rotation = lerp(ball_7.rotation, ball_8.rotation + (ball_1.rotation / 2), 0.1125)
	ball_6.rotation = lerp(ball_6.rotation, ball_7.rotation + (ball_8.rotation / 3), 0.075)
	ball_5.rotation = lerp(ball_5.rotation, ball_6.rotation + (ball_7.rotation / 4), 0.075)
	ball_4.rotation = lerp(ball_4.rotation, ball_5.rotation + (ball_6.rotation / 4), 0.1125)
	...
	ball_target.global_position = lerp(ball_target.global_position, $metarig/GeneralSkeleton/BoneAttachment3D2.global_position, 0.3)
